 ...
 */
public abstract class DisplayImages {
    protected static final Logger log = Logger.getLogger(DisplayImagesSwing.class);
    ...
    protected abstract void draw(BufferedImage image);

    protected abstract void initializeWindow(int width, int height);

    protected void initialize(Mat imageMatrix) {
